...
/**
 * Created by frazatas on 01/5/2016.
 */
public class HoldResult extends ActionBarActivity {
    ListAdapter adapter ;
    String myJSON;
    ...
    protected void showList(){
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    HoldResult.this, historyList, R.layout.history_info,
    ...
    public void getDataHold(final String data1){
